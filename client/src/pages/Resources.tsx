    ...
    <div className="min-h-screen bg-slate-50 flex">
      ...
      <main className="flex-1 md:ml-64 p-8">
        <header className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-8">
          <div>
            <h1 className="text-3xl font-display font-bold text-slate-900">Library Catalog</h1>
            <p className="text-slate-500 mt-1">Browse approved resources from all collections</p>
          </div>
